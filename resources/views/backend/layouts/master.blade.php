				...
				<div class="navbar-end">
					<div class="navbar-item">
						<div class="field is-grouped">
							...
							<p class="control">
								<a class="bd-tw-button button is-small">
									<span class="icon">
...
<section class="section" style="padding-top: 6px;">
    <div class="container">
        <div class="columns has-background-black-white-text newsreel-links" style="line-height: 1em">
            <div class="column news-reel is-size-7" style="font-weight: 600;">
				<a class="has-padding-right-10 reelnav-item @yield('library')" href="{{ url('backend/home') }}">Library</a>
				<a class="menu-has-border-left reelnav-item @yield('feed')" href="{{ url('backend/feed') }}">Feed</a>
				<a class="menu-has-border-left reelnav-item @yield('recent')" href="#">My Recent</a>
				<a class="menu-has-border-left reelnav-item @yield('newsletters')" href="{{ url('backend/newsletters') }}">Newsletters</a>
				<a class="menu-has-border-left reelnav-item @yield('profile')" href="{{ url('backend/profile') }}">Profile</a>
				<a class="menu-has-border-left reelnav-item @yield('billing')" href="{{ url('backend/billing') }}">Billing</a>
				<a class="menu-has-border-left reelnav-item @yield('history')" href="{{ url('backend/history') }}">History</a>
				<a class="menu-has-border-left pull-right" href="#">Log out</a>
			</div>
        </div>
    </div>
</section>
